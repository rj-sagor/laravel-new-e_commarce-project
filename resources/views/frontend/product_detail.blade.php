            ...
            <div class="col-lg-6">
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        ...
                        @foreach ($product->ProductToMultiImage as $signal_image )
                        <div class="item">
                            <img src="{{ asset('uploads/multi_image') }}/{{ $signal_image->multipale_image }}" alt="">
                        </div>
                        @endforeach
                         </div>
            ...
            <div class="col-lg-6">
                <div class="product-single-content">
                    ...
                    <ul class="input-style">
                        ...
                        <li><button type="submit" class="btn btn-sm btn-danger" >Add to Cart</button></li>
                    </form>
                    </ul>
                    <ul class="cetagory">
                        <li>Categories:</li>
                        <li><a href="#">{{ $product->ProductToCategory->category_name }}</a></li>
...
<div class="featured-product-area">
    <div class="container">
        ...
        <div class="row">
            @foreach ($rileted_product as $rileted_product )
                
          
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="featured-product-wrap">
                    <div class="featured-product-img">
                        <img src="{{ asset('uploads/product') }}/{{ $rileted_product->image }}" alt="">
                    </div>
                    <div class="featured-product-content">
                        <div class="row">
                            <div class="col-7">
                                <h3><a href="{{ url('product/show') }}/{{ $rileted_product->slug }}">{{ $rileted_product->product_name }}</a></h3>
                                <p>{{ $rileted_product->price }}</p>
                            </div>
